...
def is_duplicated_number(three_digit):
    ...
    result = False if CNT == len(digits) else True
    # ==================================
    return result
...
def is_yes(one_more_input):
    ...
    result = True if lower_input == 'y' or lower_input == 'yes' else False
    # ==================================
    return result
...
def is_no(one_more_input):
    ...
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    lower_input = one_more_input.lower()
    result = True if lower_input == 'n' or lower_input == 'no' else False
    # ==================================
    return result


def play_baseball(random_number):
    strikes, balls = 0, 0
...
def main():
    ...
    while True:
        ...
        result = play_baseball(random_number)
